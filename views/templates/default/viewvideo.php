 <?php  $imgs = $data['video']->getListimagens() ?>
 ...
 <header class="masthead text-center text-white bgParallax" style=" background-image: url('<?php echo $this->base_url ?>views/img/<?php echo $imgs[0]->getSrc() ?>'); background-position: 0 50%;">
      <div class="masthead-content">
        <div class="container">
          <h1 class="masthead-heading mb-0"><?php echo $data['video']->getTitle(); ?></h1>
        </div>
      </div>
  ...
  <section class="news custom-views">
      <div class="container text-center">
          <p><?php echo $data['video']->getArticle(); ?></p>

            <div class="col-lg-8 mx-auto">
             <iframe class="iframe" width="560" height="315" src="https://www.youtube.com/embed/<?php echo $data['video']->getListvideos()[0]->getCode() ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
    </div>
