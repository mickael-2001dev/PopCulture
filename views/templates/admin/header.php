...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $this->asset ?>bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
...
<div class="skin-purple wrapper">
  ...
  <header class="skin-purple main-header">
    <!-- Logo -->
    <a href="<?php echo $this->base_url?>home" class="logo">
