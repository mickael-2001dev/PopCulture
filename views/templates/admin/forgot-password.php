  ...
  <section class="news custom-views">
      <div class="container">
            ...
            <div class="text-center message-section">
              <p class="contact-p">Esqueci minha Senha</p>
              <form method="post">
              ...
              <div class="form-group row justify-content-center">
                ...
                <div class="form-group row justify-content-center">
                  <input type="submit" name="forget" class="btn btn-primary btn-block btn-lg rounded-pill col-lg-4 d-block mx-auto" value="Enviar">
                </div>
                 <?php if($data['msg']): ?>
                 <div class="form-group row justify-content-center">
