     ...
     el: '#news-deleted',
        ...
        methods: {
          getNews: function() {
            $('table').hide();
            $('.loading-img').show();
            axios.get('/PopCulture/app/AdminNews/getDeleted').then(response => {
              this.results = response.data;
            }).then(()=>{
              $('table').show();
              $('.loading-img').hide();
              $('#news-table-deleted').DataTable({
                 "paging": true,
                  "ordering": true,
                  "info": true,
                  "autoWidth": false
...
var videopageDeleted = new Vue({
      el: '#videopage-deleted',
          data: {
          results: [
        ...
        methods: {
          getVideo: function() {
            $('table').hide();
            $('.loading-img').show();
            axios.get('/PopCulture/app/AdminVideo/getDeleted').then(response => {
              this.results = response.data
            }).then(()=>{
              $('table').show();
              $('.loading-img').hide();
              $('#video-table-deleted').DataTable({
                "paging": true,
                            "ordering": true,
                            "info": true,
                            "autoWidth": false
      ...
      el: '#post-deleted',
        ...
        methods: {
          getPost: function() {
            $('table').hide();
            $('.loading-img').show();
            axios.get('/PopCulture/app/AdminPost/getDeleted').then(response => {
              this.results = response.data;
            }).then(()=>{
              $('table').show();
              $('.loading-img').hide();
              $('#post-table-deleted').DataTable({
                 "paging": true,
                  "ordering": true,
                  "info": true,
                  "autoWidth": false
